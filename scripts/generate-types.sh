...
TEMP_OUTPUT_PATH="libs/shared/types/src/lib/generated-types.temp.ts"
...
echo "   • $OUTPUT_PATH"
echo "   • libs/shared/types/src/index.ts
echo ""
...
echo "   type SeasonsResponse = components['schemas']['SeasonsApiResponse'];"
echo "   type SeasonWinner = components['schemas']['SeasonWinner'];"
echo "   type HealthResponse = components['schemas']['HealthResponse'];"
echo ""
echo "   // Access nested types:"
echo "   type Driver = components['schemas']['Driver'];"
echo "   type Constructor = components['schemas']['Constructor'];"
echo ""
