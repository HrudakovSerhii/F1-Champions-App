...
export const CHAMPION_DETAILS_SCREEN = {
  // Page Layout
...
export const SEASON_DETAILS_SCREEN = {
  // Page Layout
 ...
 */
export type HomeScreenTestIds = typeof HOME_SCREEN;
export type ChampionDetailsTestIds = typeof CHAMPION_DETAILS_SCREEN;
export type SeasonsScreenTestIds = typeof SEASONS_SCREEN;
export type SeasonDetailsTestIds = typeof SEASON_DETAILS_SCREEN;
export type CommonTestIds = typeof COMMON;
...
export const ALL_TEST_IDS = Object.freeze({
  ...flatten(HOME_SCREEN, 'HOME_SCREEN'),
  ...flatten(CHAMPION_DETAILS_SCREEN, 'CHAMPION_DETAILS_SCREEN'),
  ...flatten(SEASONS_SCREEN, 'SEASONS_SCREEN'),
  ...flatten(SEASON_DETAILS_SCREEN, 'SEASON_DETAILS_SCREEN'),
